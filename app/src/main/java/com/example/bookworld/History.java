...
import com.example.bookworld.bookdata.HistoryAdapter;
...
public class History extends AppCompatActivity implements HistoryAdapter.OnBookClickListener {

    private FirebaseFirestore db;
    private HistoryAdapter trendingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favouriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String genreName = "History"; // Replace with the actual genre if it's dynamic
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        if (!task.getResult().isEmpty()) {
                                            ...
                                            Toast.makeText(History.this, "Genre already added to favourite", Toast.LENGTH_SHORT).show();
                                        } else {
                                            ...
                                            db.collection("users").document(userId).collection("Favourite genre")
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                                            if (task.isSuccessful()) {
                                                                Toast.makeText(History.this, "Genre added successfully", Toast.LENGTH_SHORT).show();
                                                            } else {
                                                                Toast.makeText(History.this, "Failed to add genre", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                        }
                                        ...
                                        // Handle the error
                                        Toast.makeText(History.this, "Error checking for existing genre", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                } else {
                    Toast.makeText(History.this, "Genre name cannot be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(query)) {
                    ...
                    Toast.makeText(History.this, "Please enter a search query", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        threeDotsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Navigate to the "three dots" activity
                Intent intent = new Intent(History.this, three_dots.class);
                startActivity(intent);
            }
        });
    ...
    public void onBookClick(Book book) {
        if ("Not for Sale".equalsIgnoreCase(book.getPrice())) {
            ...
            Intent intent = new Intent(History.this, BuyDetails.class);
            intent.putExtra("BOOK_ID", book.getId());
            intent.putExtra("BOOK_TITLE", book.getTitle());
            intent.putExtra("BOOK_AUTHOR", book.getAuthor());
            intent.putExtra("BOOK_DESCRIPTION", book.getDescription());
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(History.this, "Error fetching books", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
