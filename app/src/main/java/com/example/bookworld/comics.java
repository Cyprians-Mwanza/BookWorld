...
import com.example.bookworld.bookdata.ComicsAdapter;
...
public class comics extends AppCompatActivity implements ComicsAdapter.OnBookClickListener {

    private FirebaseFirestore db;
    private ComicsAdapter trendingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trendingAdapter = new ComicsAdapter(bookList, this);
...
// Set onClick listener for the "Add to Favourite Genre" button
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        if (!task.getResult().isEmpty()) {
                                            ...
                                            Toast.makeText(comics.this, "Genre already added to favourite", Toast.LENGTH_SHORT).show();
                                        } else {
                                            ...
                                            db.collection("users").document(userId).collection("Favourite genre")
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                                            if (task.isSuccessful()) {
                                                                Toast.makeText(comics.this, "Genre added successfully", Toast.LENGTH_SHORT).show();
                                                            } else {
                                                                Toast.makeText(comics.this, "Failed to add genre", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                        }
                                        ...
                                        // Handle the error
                                        Toast.makeText(comics.this, "Error checking for existing genre", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                } else {
                    Toast.makeText(comics.this, "Genre name cannot be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(query)) {
                    ...
                    Toast.makeText(comics.this, "Please enter a search query", Toast.LENGTH_SHORT).show();
                }
            }
        });
        myBooksLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(comics.this, MyBooks.class);
        ...
        searchLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(comics.this, search_discovery.class);
                startActivity(intent);
            }
        });
        ...
        moreLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(comics.this, More.class);
                startActivity(intent);
            }
        });
        homeLayout.setOnClickListener(view -> {
            Intent intent = new Intent(comics.this, Home.class);
            startActivity(intent);
        });
        ...
        threeDotsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Navigate to the "three dots" activity
                Intent intent = new Intent(comics.this, three_dots.class);
                startActivity(intent);
            }
        });
    ...
    public void onBookClick(Book book) {
        if ("Not for Sale".equalsIgnoreCase(book.getPrice())) {
            ...
            Intent intent = new Intent(comics.this, BookDetails.class);
            ...
            Intent intent = new Intent(comics.this, BuyDetails.class);
            intent.putExtra("BOOK_ID", book.getId());
            intent.putExtra("BOOK_TITLE", book.getTitle());
            intent.putExtra("BOOK_AUTHOR", book.getAuthor());
            intent.putExtra("BOOK_DESCRIPTION", book.getDescription());
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(comics.this, "Error fetching books", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
