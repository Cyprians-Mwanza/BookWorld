...
public class Technology extends AppCompatActivity implements TechnologyAdapter.OnBookClickListener {
    ...
    private TechnologyAdapter trendingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize views
        RecyclerView recyclerView = findViewById(R.id.recyclerTechnology);
        searchEditText = findViewById(R.id.searchEditText);
        searchButton = findViewById(R.id.searchButton);
        messageTextView = findViewById(R.id.messageTextView);
        backButton = findViewById(R.id.backButton);
        threeDotsButton = findViewById(R.id.logoutButton);  LinearLayout homeLayout = findViewById(R.id.hometech);
        ...
        trendingAdapter = new TechnologyAdapter(bookList, this);
        ...
        myBooksLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Technology.this, MyBooks.class);
        ...
        moreLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Technology.this, More.class);
                startActivity(intent);
            }
        });
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Technology.this, "Error fetching books", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
