...
public class BuyDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            // Fetch 'daysToBorrow' as an integer instead of a String
            int daysToBorrow = extras.getInt("daysToBorrow", 0);  // Default to 0 if not found
            ...
            addcartButton.setOnClickListener(v -> {
                // Create a Book object with the updated 'daysToBorrow' as int
                ...
                bookData.put("daysToBorrow", book.getDaysToBorrow());  // Ensure this is added to Firestore as an int
