...
public class fantasy extends AppCompatActivity implements FantasyAdapter.OnBookClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favouriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String genreName = "Fantasy"; // Replace with the actual genre if it's dynamic
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        if (!task.getResult().isEmpty()) {
                                            ...
                                            Toast.makeText(fantasy.this, "Genre already added to favourite", Toast.LENGTH_SHORT).show();
                                        } else {
                                            ...
                                            db.collection("users").document(userId).collection("Favourite genre")
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<DocumentReference> task) {
                                                            if (task.isSuccessful()) {
                                                                Toast.makeText(fantasy.this, "Genre added successfully", Toast.LENGTH_SHORT).show();
                                                            } else {
                                                                Toast.makeText(fantasy.this, "Failed to add genre", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                        }
                                        ...
                                        // Handle the error
                                        Toast.makeText(fantasy.this, "Error checking for existing genre", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                } else {
                    Toast.makeText(fantasy.this, "Genre name cannot be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        moreLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(fantasy.this, More.class);
                startActivity(intent);
            }
        });
    ...
    public void onBookClick(Book book) {
        if ("Not for Sale".equalsIgnoreCase(book.getPrice())) {
            ...
            Intent intent = new Intent(fantasy.this, BuyDetails.class);
            intent.putExtra("BOOK_ID", book.getId());
            intent.putExtra("BOOK_TITLE", book.getTitle());
            intent.putExtra("BOOK_AUTHOR", book.getAuthor());
            intent.putExtra("BOOK_DESCRIPTION", book.getDescription());
