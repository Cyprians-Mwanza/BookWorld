...
public class FictionAdapter extends RecyclerView.Adapter<FictionAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public FictionAdapter(List<Book> bookList, OnBookClickListener listener) {
    ...
    static class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView title;
        TextView author;
        TextView price; // Reference to book price TextView in item layout
