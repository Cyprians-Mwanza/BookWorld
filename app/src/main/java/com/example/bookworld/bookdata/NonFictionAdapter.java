...
public class NonFictionAdapter extends RecyclerView.Adapter<NonFictionAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public NonFictionAdapter(List<Book> bookList, OnBookClickListener listener) {
