...
public class ComicsAdapter extends RecyclerView.Adapter<ComicsAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public ComicsAdapter(List<Book> bookList, OnBookClickListener listener) {
