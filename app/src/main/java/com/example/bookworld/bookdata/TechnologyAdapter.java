...
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public TechnologyAdapter(List<Book> bookList, OnBookClickListener listener) {
