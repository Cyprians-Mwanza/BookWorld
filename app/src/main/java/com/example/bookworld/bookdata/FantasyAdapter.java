...
public class FantasyAdapter extends RecyclerView.Adapter<FantasyAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public FantasyAdapter(List<Book> bookList, OnBookClickListener listener) {
