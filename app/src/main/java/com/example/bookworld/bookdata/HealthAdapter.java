...
public class HealthAdapter extends RecyclerView.Adapter<HealthAdapter.BookViewHolder> {

    private List<Book> bookList;
    private OnBookClickListener listener;

    public HealthAdapter(List<Book> bookList, OnBookClickListener listener) {
